<template>
	<div class="header">
		<div class="content-wrapper">
			...
			<div v-if="seller.supports" class="support-count" @touchend="showDetail">
				<span class="count">{{seller.supports.length}}个</span>
				<i class="icon-keyboard_arrow_right"></i>
			</div>
		</div>
		<div class="bulletin-wrapper" @touchend="showDetail">
		...
		<div v-show="detailShow"  class="detail">
			...
			<div class="detail-close" v-on:touchend="hideDetail">
